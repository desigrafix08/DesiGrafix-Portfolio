        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Crafting high-impact motion graphics, dynamic video animations,
                3D visual assets, and engaging promotional stories across digital mediums.
              </p>
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">Promo Videos</div>
              </div>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Building distinctive brand identities, event & exhibition collaterals,
                marketing creatives, and refined UI/UX from concept to production.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                ...
                <div className="what-tags">Event Branding</div>
